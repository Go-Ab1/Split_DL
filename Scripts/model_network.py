...
class InvResidualBlock(nn.Module):
    '''
    Inverted Residual Block as used in MobileNetV2.
    Consists of:
    - 1x1 pointwise convolution (expansion)
    - 3x3 depthwise convolution
    - 1x1 pointwise convolution (projection)
    Includes residual connection if input and output channels match and stride=1.
    '''
...
class ModifiedMobileNetV2(nn.Module):
    def __init__(self, output_size=10, alpha=1):
        ...
        # First convolution layer (32*32*3 -> 32*32*32)
